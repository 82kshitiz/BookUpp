...
import com.example.amitgyawali.bookupp.Preference.PreferenceActivity;
import com.example.amitgyawali.bookupp.Tools.BookInformation;
import com.example.amitgyawali.bookupp.Tools.ViewMode;



public class barcodeScan extends AppCompatActivity implements TaskFragment.TaskListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(barcodeScan.this);
    ...
    private void setUpViewButton(){
        Button viewBtn = (Button)findViewById(R.id.viewBook_button);
        viewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (v.getId() == R.id.viewBook_button) {
                    Intent bookViewerIntent = new Intent(barcodeScan.this, BookViewerActivity.class);
